 ...
 *                                                                         *
 ***************************************************************************/
#ifndef INCLUDE_DIAG_DIAG_LIB_H_
#define INCLUDE_DIAG_DIAG_LIB_H_
...
int diag_send_event_stat_and_env_data(uint8_t msg_prio, uint16_t module_id,
                                      uint16_t event_id, uint8_t event_sta,
                                      uint8_t env_data_gen_timing,
                                      uint8_t *env_data, size_t env_len);
...
DIAG_LIB_EXT TDisg_lib_status diag_netlink_get_mod_event_sta(uint32_t moduleid,
                                                             uint32_t event_id);
#endif  // INCLUDE_DIAG_DIAG_LIB_H_

...
// NOLINTNEXTLINE
HBDK_HBIR_CEREAL_REGISTER_TYPE_WITH_VERSION(hbdk::hbir::ConvolutionLayer, 3);
// NOLINTNEXTLINE
HBDK_HBIR_CEREAL_REGISTER_TYPE_WITH_VERSION(hbdk::hbir::SConvolutionLayer, 2);
// NOLINTNEXTLINE
...
// NOLINTNEXTLINE
HBDK_HBIR_CEREAL_REGISTER_TYPE_WITH_VERSION(hbdk::hbir::ReshapeLayer, 2);
// NOLINTNEXTLINE
...
std::string GetLayerTypeName(const Layer::layer_type_t type);

std::string GetElementTypeName(const Tensor::element_type_t type);

std::string ShapeToString(Shape shape);
std::string Shape2DToString(Shape2D shape);

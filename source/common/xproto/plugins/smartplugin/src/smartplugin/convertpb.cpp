...
void setAttribute(x3::Attributes* attribute,
    ...
    attribute->set_value_string_(value_string);
...
void convertVehicleInfo(
  ...
  setAttribute(is_double_plate, "is_double_plate",
               vehicle_info.plate_info.is_double_plate ? 1 : 0, "", 0);
  // 车牌关键点
  ...
  setAttribute(plate_num, "plate_num", 0, vehicle_info.plate_info.plate_num, 0);
  // color 车牌颜色

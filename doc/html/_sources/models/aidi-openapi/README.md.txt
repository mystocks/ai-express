...
```shell
pip install aidi==1.0.0 -i http://pypi.hobot.cc/hobot-local/simple --trusted-host pypi.hobot.cc
pip install aidi_userauth==1.0.0 -i http://pypi.hobot.cc/hobot-local/simple --trusted-host pypi.hobot.cc
pip install aidi_utils==1.0.0 -i http://pypi.hobot.cc/hobot-local/simple --trusted-host pypi.hobot.cc
pip install aidi_notify==1.0.0 -i http://pypi.hobot.cc/hobot-local/simple --trusted-host pypi.hobot.cc
```
